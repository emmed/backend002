...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('state', models.CharField(choices=[('Ordered', 'Ordered'), ('Pending', 'Pending'), ('Placed', 'Placed')], max_length=200, null=True)),
        ...
        migrations.AddField(
            model_name='product',
            name='subject',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='restapi.Subject'),
        ),
        migrations.AddField(
            model_name='product',
            name='user',
